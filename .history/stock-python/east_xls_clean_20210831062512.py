...
cols = [2, 3, 4, 7, 8, 9, 10, 12, 14, 15, 16, 17, 18, 19, 20, 22, 25, 28, 33, 34, 35, 36]
dn.iloc[:, [x for x in cols]] = dn.iloc[:, [x for x in cols]].apply(pd.to_numeric, errors='coerce', downcast='float')
# dn.iloc[:, [5]] = dn.iloc[:, [5]].apply()
