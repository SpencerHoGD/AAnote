...
def getTodayFile(today):
    orgWorkDir = r'C:\Users\hxm\Downloads\eastmoney_xls'
    orgFileName = 'stock_hs_{}.xls'.format(today)
...
def save_csv_file(df):
    ...
    saveFileName = 'stock_hs_{}_clearn.csv'.format(today)
