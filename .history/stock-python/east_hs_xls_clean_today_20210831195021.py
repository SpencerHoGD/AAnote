...
def getTodayFile(orgDir):
    orgDir = r'C:\Users\hxm\Downloads\eastmoney_xls'
    orgFileName = 'stock_hs_{}.xls'.format(datetime.date.today())

    orgFilePath = os.path.join(orgWorkDir, orgFileName)
...
def save_csv_file(df):
    saveDir = r'C:\Users\hxm\Downloads\eastmoney_xls\clearned'
    saveFileName = 'stock_hs_{}_clearn.csv'.format(datetime.date.today())
...
if __name__ == "__main__":
    orgFileName = 'stock_hs_{}.xls'.format(datetime.date.today())
    orgDir = r'C:\Users\hxm\Downloads\eastmoney_xls'
    saveDir = orgDir + '\clearned'

    df = getTodayFile(today)
    print(df.head())