...
dfnew1['名称'] = dfnew1['名称'].str.strip().astype('str')
dfnew1['代码'] = dfnew1['代码'].str.replace('= ', '')
dfnew1['代码'] = dfnew1['代码'].str.replace('"', '')
dfnew1['代码'] = dfnew1['代码'].apply(pd.to_numeric, downcast='float')
dfnew1 = dfnew1[~dfnew1['代码'].isin([i for i in list1])]
dfnew1['最新'] = dfnew1['最新'].apply(pd.to_numeric, errors='coerce', downcast='float')
dfnew1['涨幅%'] = dfnew1['涨幅%'].apply(pd.to_numeric, errors='coerce', downcast='float')
dfnew1['涨跌'] = dfnew1['涨跌'].apply(pd.to_numeric, errors='coerce', downcast='float')
# dfnew1.to_csv(p2)
# print(dfnew1['涨跌'])
