...
# with open(p1,'r', encoding='unic') as f:
#     df = pd.read_excel(f)
...
# df = pd.read_excel(r'C:\Users\hxm\Downloads\eastmoney_xls\stock_hs_0830.xls', engine='')
df = pd.read_excel(r'C:\Users\hxm\Downloads\eastmoney_xls\bak\stock_hs_0830.xls')
print(df.info())